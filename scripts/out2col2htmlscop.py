...
###############################################################################
#
# out2col2htmlscop.py - Convert 2 column format (score,domainid) to HTML
#                       with SCOP information and links to SCOP
#
# See usage comment in docstring for main()
#
# File:    out2col2htmlscop.py
# Author:  Alex Stivala
# Created: March 2010
#
# $Id: out2col2htmlscop.py 2038 2008-11-25 05:39:26Z astivala $
# 
###############################################################################
...
def main():
    """
    main for out2col2htmlscop.py

    Usage: out2col2htmlscop.py cachefile
