...
# $Id: plotsearchroc_folds_discrete_reduced.r 1946 2008-10-04 05:14:43Z astivala $
...
postscript('searchroc_folds_discrete_reduced.eps',onefile=FALSE,paper="special",horizontal=FALSE, 
           width = 9, height = 6)

plot(c(0,1),c(0,1),type='l',xlim=c(0,1),ylim=c(0,1),xlab="False Positive Rate",ylab="True Positive Rate",lty=3,main='ROC curves for discrete version against ASTRAL 95% seq id SCOP as truth')
