...
#
# $Id: ssesubsetremap.py 2038 2008-11-25 05:39:26Z astivala $
# 
###############################################################################
...
def usage(progname):
    ...
    sys.stderr.write("Usage: " +progname + " [-d domainid] sse_num_list\n")
    sys.exit(1)
...
def main():
    ...
    Usage: sol2ssemap.py [-d domainid] sse_num_list
