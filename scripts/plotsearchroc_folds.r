...
# Alex Stivala
# July 2008
# $Id: plotsearchroc_folds.r 1946 2008-10-04 05:14:43Z astivala $
...
namevec=c('beta-grasp', 'Immunoglobulin', 'TIM-barrel', 'Plait (ferredoxin)', 'GFP-like', 'Key-barrel', 'Jelly-roll')
...
betagrasp <- read.table('d1ubia_.tsrchn.orderpen1.typepen0.rtab', header=TRUE)
immunoglobulin <- read.table('d1ae6h1.tsrchn.orderpen1.typepen0.rtab', header=TRUE)
timbarrel <- read.table('d1tima_.tsrchn.orderpen1.typepen0.rtab', header=TRUE)
plait <- read.table('d1bhne_.tsrchn.orderpen1.typepen0.rtab', header=TRUE)
greekkey <- read.table('d1h6rb_.tsrchn.orderpen1.typepen0.rtab', header=TRUE)
keybarrel <- read.table('d1tttb1.tsrchn.orderpen1.typepen0.rtab', header=TRUE)
jellyroll <- read.table('d2phlb1.tsrchn.orderpen1.typepen0.rtab', header=TRUE)
...
plot(c(0,1),c(0,1),type='l',xlim=c(0,1),ylim=c(0,1),xlab="False Positive Rate",ylab="True Positive Rate",lty=3,main='ROC curves against ASTRAL 95% seq id SCOP as truth')
